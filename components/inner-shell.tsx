...
export function InnerFooter() { return <footer><div className="footer-top"><div className="footer-brand"><Link className="brand" href="/"><span className="brand-mark"><Sun size={20}/></span><span>OM<br/><b>SUNBUILD</b></span></Link><p>Thoughtful solar solutions<br/>for a brighter tomorrow.</p></div><div><p className="footer-label">EXPLORE</p><Link href="/about">About us</Link><Link href="/products">Products</Link><Link href="/#solutions">Solutions</Link></div><div><p className="footer-label">GET IN TOUCH</p><a href="tel:+919109838902">+91 91098 38902</a><a href="mailto:hello@omsunbuild.com">hello@omsunbuild.com</a><span>Your city, India</span></div><div><p className="footer-label">FOLLOW ALONG</p><a href="https://wa.me/910000000000">WhatsApp <ArrowUpRight size={13}/></a></div></div><div className="footer-bottom"><span>© 2025 OM SUNBUILD. All rights reserved.</span><span>Solar solutions, thoughtfully built.</span></div></footer> }
